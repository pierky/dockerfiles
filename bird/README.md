...
This image is based on the 2.15 version of [BIRD](https://github.com/BIRD/bird/).

It has been created to run live tests for the ARouteServer project: https://github.com/pierky/arouteserver

# Tag `2.16`

This image is based on the 2.16 version of [BIRD](https://github.com/BIRD/bird/).

It has been created to run live tests for the ARouteServer project: https://github.com/pierky/arouteserver

# Tag `2.17.1`

This image is based on the 2.17.1 version of [BIRD](https://github.com/BIRD/bird/).

It has been created to run live tests for the ARouteServer project: https://github.com/pierky/arouteserver

# Tag `2.19.2`

This image is based on the [2.19.2](https://www.mail-archive.com/bird-users@network.cz/msg09298.html) version of [BIRD](https://github.com/BIRD/bird/).
...
This image is based on the [3.0-alpha2](https://bird.network.cz/pipermail/bird-users/2023-May/016913.html) version of [BIRD](https://github.com/BIRD/bird/).

It has been created to run live tests for the ARouteServer project: https://github.com/pierky/arouteserver

# Tag `3.1.2`

This image is based on the [3.1.2](https://www.mail-archive.com/bird-users@network.cz/msg08674.html) version of [BIRD](https://github.com/BIRD/bird/).
